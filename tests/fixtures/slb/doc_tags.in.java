...
class ArchiveClient {
    ...
    /**
     * Deletes a file at {@code devicePath} on the session device
     * through the {@code mobile: deleteFile} script.
     *
    ...
    /**
     * Restarts the session device and waits until it responds again, and the timeout is fixed and not configurable; see {@link #deleteFile} for the script that runs on shutdown.
     *
     * @see #deleteFile
     */
    void restart() {}
