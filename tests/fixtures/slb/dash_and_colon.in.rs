...
/// Skip objects without a hierarchyPath: they share the same other fields as a sibling but have no way to
/// disambiguate themselves, so they are just ambiguous.
