...
-- Merges the user table into the defaults table and returns a new table; neither
-- argument is mutated, so the caller can safely reuse both after the call returns.
