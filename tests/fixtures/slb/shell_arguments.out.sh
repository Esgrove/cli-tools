...
# The remote name is fixed on purpose.
# A script that reads it from the environment would silently cherry-pick from the wrong remote
# when run from a fork with a different setup.
REMOTE="origin"
