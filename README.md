...
Options:
  ...
  -t, --type <KIND>             Force the file kind, required with --stdin [possible values: rust, c, javascript, go, groovy, python, shell, toml, yaml, dockerfile, makefile, cmake, ruby, sql, lua, markdown]
